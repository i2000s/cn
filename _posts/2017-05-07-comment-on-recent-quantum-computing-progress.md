...
值得注意的是，数字量子计算并非我们追求的唯一方向。引用这个领域前沿领袖之一John Preskill在最近的一篇文章中的话来说（arXiv:1801.00862），
    ...
    But because of the hefty overhead cost of quantum error correction, the reign of the analog quantum simulator
    may persist for many years. Therefore, when seeking near-term applications of quantum technology, we should
    not overlook the potential power of analog quantum simulators.
