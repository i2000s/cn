...
而系统的思维在处理复杂问题时，往往能够用小型化的类似复杂系统来实际模拟较大规模的复杂系统，不依赖于对整体的局部可拆假设，也未必需要有清晰的数学公式等先决条件才能解决，而是通过从实践中来到实践中去的思路对实践结果加以归纳总结，合理推广，有利于实现对全局优化问题的有效把握。
这种思维对面对未来越发复杂的系统问题，或许是一种必然选择和有效解决方案。
