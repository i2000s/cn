...
三、系统工程思维相对于解析思维的优势。
解析思维在于将复杂的问题分解或者转化为已知的问题并可能忽略一定的次要因素加以解决，其解决依赖于清晰的数学表达式和整体系统可以分解为各个单元的假设，但当问题非常复杂时，被分解的部分往往已经脱离的实际情况，难以比较准确的反应实际结果。
而系统的思维在处理复杂问题时，往往能够用小型化的类似复杂系统来实际模拟较大规模的复杂系统，把抽象的主要因素的作用和推动力问题解决掉之后再推而广之，其不依赖于对整体的局部可拆假设，也未必需要有清晰的数学公式等先决条件才能解决，而是通过从实践中来到实践中去的思路对实践结果加以归纳总结，合理推广，有利于实现对全局优化问题的有效把握。
这种思维对面对未来越发复杂的系统问题，类似于当今人工智能的发展趋势，或许是一种必然选择和有效解决方案。
